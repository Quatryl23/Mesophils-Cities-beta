...
public class CheckForPortalHousePlacementTrueProcedure {
	public static ListTag execute(double x, double z) {
		...
		if (border1_w > 0 && border1_e > 0) {
			if (border1_n > 0) {
				portal_house = CheckForPortalHouseProcedure.execute(x, z, path_n > 0 ? true : false, false, true, false, (path_n > 0) ? path_n : (border3_n > 0) ? border3_n : border2_n, border1_n, path_w, Random1Procedure.execute(x, z));
				if (!portal_house.isEmpty()) {
					return portal_house;
				}
			}
			if (border2_n > 0 && (border3_n > 0 || path_n > 0)) {
				portal_house = CheckForPortalHouseProcedure.execute(x, z, false, false, true, path_n > 0 ? true : false, border2_n, path_n > 0 ? path_n + 1 : border3_n, path_w, Random3Procedure.execute(x, z));
				if (!portal_house.isEmpty()) {
					return portal_house;
				}
			}
			portal_house = CheckForPortalHouseProcedure.execute(x, z, TrainStreetCalculationProcedure.execute(x + 48, z) != 0 || border1_n2 == 0 ? true : false, false, true, border2_n == 0 ? true : false,
		...
		if (border2_w > 0 && border2_e > 0) {
			if (border1_s > 0) {
				portal_house = CheckForPortalHouseProcedure.execute(x, z, path_s > 0 ? true : false, true, false, false, (path_s > 0) ? path_s : (border3_s > 0) ? border3_s : border2_s, border1_s, Random2Procedure.execute(x, z), path_w + 1);
				if (!portal_house.isEmpty()) {
					return portal_house;
				}
			}
			if (border2_s > 0 && (border3_s > 0 || path_s > 0)) {
				portal_house = CheckForPortalHouseProcedure.execute(x, z, false, true, false, path_s > 0 ? true : false, border2_s, path_s > 0 ? path_s + 1 : border3_s, Random4Procedure.execute(x, z), path_e + 1);
				if (!portal_house.isEmpty()) {
					return portal_house;
				}
			}
			portal_house = CheckForPortalHouseProcedure.execute(x, z, TrainStreetCalculationProcedure.execute(x + 48, z) != 0 || border1_s2 == 0 ? true : false, true, false, border2_s == 0 ? true : false,
					(TrainStreetCalculationProcedure.execute(x + 48, z) == 6)
		...
		if (border1_s > 0) {
			portal_house = CheckForPortalHouseProcedure.execute(x, z, path_s > 0 ? true : false, border2_w == 0 ? true : false, TrainStreetCalculationProcedure.execute(x, z + 48) != 0 || border1_w2 == 0 ? true : false, false,
		...
		if (border2_s > 0 && (border3_s > 0 || path_s > 0)) {
			portal_house = CheckForPortalHouseProcedure.execute(x, z, false, border2_e == 0 ? true : false, TrainStreetCalculationProcedure.execute(x, z + 48) != 0 || border1_e2 == 0 ? true : false, path_s > 0 ? true : false, border2_s,
		...
		portal_house = CheckForPortalHouseProcedure.execute(x, z, border1_s2 == 0 || Math.abs(TrainStreetCalculationProcedure.execute(x + 48, z + 48)) % 8 > 3, border2_e == 0,
